...
import com.tw.jobposting.service.PositionService;
...
/**
 * REST controller for managing {@link com.tw.jobposting.domain.Position}.
 */
@RestController
@RequestMapping("/api")
public class PositionResource {
    ...
    private static final String ENTITY_NAME = "jobpostingPosition";
    ...
    public List<PositionDTO> getAllPositions(@RequestParam(required = false) String filter) {
        if ("jobpost-is-null".equals(filter)) {
            log.debug("REST request to get all Positions where jobPost is null");
